...
## Simplicity?
* Setting up LILA means creating two database objects (sequence and package) [documentation file setup](docs/setup.md)
* Only a few API calls are necessary for the complete logging of a process [documentation file API](docs/API.md)
